...
def guardar_resultados(resultados_por_archivo, datos_por_año_mes, delimitadores_totales):
    """
...
def main():
    ...
    try:
        ...
        if not datos_combinados.empty:
            ...
            guardar_resultados(resultados_por_archivo, datos_por_año_mes, delimitadores_totales)
