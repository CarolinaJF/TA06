...
ruta_log = 'E04/dades/resultats.log' # Cambia esto por la ruta deseada, por ejemplo: 'C:/mis_logs' o '/home/usuario/logs'
...
archivo_log = os.path.join(ruta_log, 'E04/dades/resultats.log')
...
archivo_resultados = 'E04/dades/resultats.log'
